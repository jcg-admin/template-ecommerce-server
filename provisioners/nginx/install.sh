...
echo ""
log_info "Siguientes pasos (en orden):"
log_info "  1. Firewall:"
log_info "       sudo bash provisioners/firewall/setup_firewall.sh"
log_info "  2. fail2ban:"
log_info "       sudo bash provisioners/security/setup_fail2ban.sh"
log_info "  3. Endurecer SSH (solo VPS/bare-metal, omitir en WSL2):"
log_info "       sudo bash provisioners/security/setup_ssh_hardening.sh"
log_info "  4. Certificado SSL:"
log_info "       sudo bash provisioners/ssl/setup_ssl.sh           # produccion (Let's Encrypt)"
log_info "       sudo bash provisioners/ssl/setup_ssl.sh --dev     # WSL2 / desarrollo (self-signed)"
log_info "  5. Activar virtualhosts (DESPUES de SSL):"
log_info "       sudo bash provisioners/nginx/setup_vhost.sh"
log_info "  6. Verificar entorno:"
